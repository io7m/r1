...
public final class RKUnlitTranslucentRefractiveCases
{
  private final RKMaterialCases                      material_cases;
  private final List<KMaterialTranslucentRefractive> cases;

  public RKUnlitTranslucentRefractiveCases()
  {
    this.material_cases = new RKMaterialCases();
    this.cases = this.material_cases.getCasesUnlitTranslucentRefractive();
  }

  public List<KMaterialTranslucentRefractive> getCases()
  {
    return this.cases;
  }
}
