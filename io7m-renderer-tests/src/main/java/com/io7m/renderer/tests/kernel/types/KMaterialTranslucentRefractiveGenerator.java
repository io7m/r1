  ...
  Generator<KMaterialTranslucentRefractive>
{
  ...
  private final @Nonnull Generator<KMaterialRefractive>                 refr_gen;
  ...
  public KMaterialTranslucentRefractiveGenerator(
    ...
    final @Nonnull Generator<KMaterialRefractive> refr_gen1)
  {
  ...
  @Override public KMaterialTranslucentRefractive next()
  {
    try {
