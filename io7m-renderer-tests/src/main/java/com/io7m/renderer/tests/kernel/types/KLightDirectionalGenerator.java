  ...
  Generator<KLightDirectional>
{
  ...
  private final @Nonnull Generator<RVectorI3F<RSpaceWorldType>> direction_gen;

  public KLightDirectionalGenerator(
    final @Nonnull Generator<RVectorI3F<RSpaceRGBType>> colour_gen1,
    final @Nonnull Generator<RVectorI3F<RSpaceWorldType>> direction_gen1)
  {
    this.colour_gen = colour_gen1;
    this.direction_gen = direction_gen1;
  }

  @Override public @Nonnull KLightDirectional next()
  {
    try {
