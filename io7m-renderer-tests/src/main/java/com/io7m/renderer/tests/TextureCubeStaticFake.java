...
public final class TextureCubeStaticFake implements TextureCubeStaticUsable
{
  public static Generator<TextureCubeStaticUsable> generator(
    final @Nonnull Generator<String> name_gen)
  {
    return new Generator<TextureCubeStaticUsable>() {
      @Override public TextureCubeStaticUsable next()
      {
        return TextureCubeStaticFake.getDefaultWithName(name_gen.next());
      }
    };
  }

  public static @Nonnull TextureCubeStaticUsable getDefault()
  {
    try {
      final AreaInclusive in_area =
        new AreaInclusive(
          ...
          new RangeInclusive(0, 31));
      return new TextureCubeStaticFake(
        1,
        false,
        in_area,
  ...
  public static TextureCubeStaticUsable getDefaultWithName(
    final String name)
  {
    try {
      final AreaInclusive in_area =
  ...
  private TextureCubeStaticFake(
    ...
    final @Nonnull TextureWrapR wrap_r1,
    ...
    final Object obj)
  {
    ...
    final TextureCubeStaticFake other = (TextureCubeStaticFake) obj;
    if (this.area == null) {
      if (other.area != null) {
        return false;
      }
  ...
  @Override public int hashCode()
  {
    ...
    result =
      (prime * result) + ((this.wrap_r == null) ? 0 : this.wrap_r.hashCode());
    result =
