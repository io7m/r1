...
@SuppressWarnings("static-method") public final class KMaterialOpaqueAlphaDepthTest
{
  @Test public void testAttributes()
  {
    ...
    final Generator<TextureCubeStaticUsableType> cube_tex_gen =
      FakeTextureCubeStatic.generator(name_gen);
    ...
    final KMaterialOpaqueAlphaDepthGenerator gen =
      new KMaterialOpaqueAlphaDepthGenerator(
        matrix_gen1,
        normal_gen1,
        albedo_gen1,
        emissive_gen1,
    ...
    QuickCheck.forAllVerbose(
      gen,
      new AbstractCharacteristic<KMaterialOpaqueAlphaDepth>() {
        @Override protected void doSpecify(
          final KMaterialOpaqueAlphaDepth m)
          throws Throwable
        {
          Assert.assertEquals(
            m.withAlphaThreshold(0.5f).getAlphaThreshold(),
            0.5f,
            0.0f);
