...
@SuppressWarnings("static-method") public final class KMaterialOpaqueRegularTest
{
  @Test public void testAttributes()
  {
    ...
    final KMaterialOpaqueRegularGenerator gen =
    ...
    QuickCheck.forAllVerbose(
      gen,
      new AbstractCharacteristic<KMaterialOpaqueRegular>() {
