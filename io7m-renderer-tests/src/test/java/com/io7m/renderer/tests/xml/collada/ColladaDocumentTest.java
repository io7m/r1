...
package com.io7m.renderer.tests.xml.collada;
...
@SuppressWarnings("static-method") public class ColladaDocumentTest
{
  ...
  {
    try {
      final String file = "/com/io7m/renderer/tests/xml/collada/" + name;
  ...
  public static @NonNull LogType getLog()
  {
    try {
      ...
      final LogPolicyType policy =
        LogPolicyProperties.newPolicy(p, "com.io7m.renderer.xml.collada");
