...
public final class KMaterialOpaqueAlphaDepthGenerator implements
  Generator<KMaterialOpaqueAlphaDepth>
{
  ...
  public KMaterialOpaqueAlphaDepthGenerator(
  ...
  @SuppressWarnings("null") @Override public KMaterialOpaqueAlphaDepth next()
  {
