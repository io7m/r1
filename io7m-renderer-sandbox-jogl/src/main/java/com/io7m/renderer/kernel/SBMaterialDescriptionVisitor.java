...
public interface SBMaterialDescriptionVisitor<A, E extends Throwable>
{
  /**
  ...
  @Nonnull A materialDescriptionVisitOpaque(
  ...
  @Nonnull A materialDescriptionVisitTranslucent(
