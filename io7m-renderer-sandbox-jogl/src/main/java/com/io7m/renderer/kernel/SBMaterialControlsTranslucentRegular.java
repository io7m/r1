  ...
  SBControlsDataType<SBMaterialDescriptionTranslucentRegular>
{
  ...
  private final @Nonnull SBFloatHSlider                         controls_opacity;
    ...
    throws ConstraintError
  {
    ...
    this.name = name;
    this.controls_opacity = new SBFloatHSlider("Opacity", 0.0f, 1.0f);
    this.controls_opacity.setCurrent(1.0f);
    ...
    final @Nonnull DesignGridLayout layout)
  {
    ...
    layout
      .row()
      .group(this.group)
      .grid(this.controls_opacity.getLabel())
      .add(this.controls_opacity.getSlider(), 3)
      .add(this.controls_opacity.getField());
  ...
  {
    this.controls_opacity.setCurrent(desc.getOpacity());
      ...
      ConstraintError
  {
    return new SBMaterialDescriptionTranslucentRegular(
      ...
      this.controls_opacity.getCurrent());
  }
}
