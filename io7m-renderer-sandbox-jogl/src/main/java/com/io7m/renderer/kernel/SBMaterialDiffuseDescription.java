...
public final class SBMaterialDiffuseDescription
{
  public static @Nonnull SBMaterialDiffuseDescription fromXML(
    final @Nonnull Element e)
    throws RXMLException,
      ConstraintError
  {
    final URI uri = SBSceneDescription.SCENE_XML_URI;
    RXMLUtilities.checkIsElement(e, "diffuse", uri);
    ...
    return new SBMaterialDiffuseDescription(colour, mix, texture);
  }
  ...
  public SBMaterialDiffuseDescription(
    ...
    final Object obj)
  {
    ...
    final SBMaterialDiffuseDescription other =
      (SBMaterialDiffuseDescription) obj;
  ...
  @Override public String toString()
  {
    ...
    builder.append("SBMaterialDiffuseDescription [colour=");
  ...
  @SuppressWarnings("boxing") @Nonnull Element toXML()
  {
    ...
    final Element e = new Element("s:diffuse", uri);
