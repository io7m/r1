...
@SuppressWarnings("synthetic-access") @EqualityStructural public final class KNewShadowMapDescriptionDirectionalVariance implements
  KNewShadowMapDescriptionDirectionalType
{
  @EqualityReference private static final class Builder implements
    KNewShadowMapDescriptionDirectionalVarianceBuilderType
  {
    ...
    Builder(
      final KNewShadowMapDescriptionDirectionalVariance d)
    {
    ...
    @Override public KNewShadowMapDescriptionDirectionalVariance build()
    {
      final RangeInclusiveL range =
        new RangeInclusiveL(0, (long) (Math.pow(2, this.exponent) - 1));
      final AreaInclusive area = new AreaInclusive(range, range);
      return new KNewShadowMapDescriptionDirectionalVariance(
        this.exponent,
        area,
        this.filter_mag,
        this.filter_min,
  ...
  private static final KNewShadowMapDescriptionDirectionalVariance DEFAULT;

  static {
    DEFAULT =
      KNewShadowMapDescriptionDirectionalVariance.newBuilder().build();
  }
  ...
  public static KNewShadowMapDescriptionDirectionalVariance getDefault()
  {
    return KNewShadowMapDescriptionDirectionalVariance.DEFAULT;
  }
  ...
  private KNewShadowMapDescriptionDirectionalVariance(
    ...
    @Nullable final Object obj)
  {
    ...
    final KNewShadowMapDescriptionDirectionalVariance other =
      (KNewShadowMapDescriptionDirectionalVariance) obj;
