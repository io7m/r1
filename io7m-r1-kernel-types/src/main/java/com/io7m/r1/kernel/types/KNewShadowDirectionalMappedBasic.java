...
@SuppressWarnings("synthetic-access") @EqualityStructural public final class KNewShadowDirectionalMappedBasic implements
  KNewShadowDirectionalType
{
  @EqualityReference private static final class Builder implements
    KNewShadowDirectionalMappedBasicBuilderType
  {
    private float                                    depth_bias;
    private float                                    factor_min;
    private KNewShadowMapDescriptionDirectionalBasic map_desc;

    Builder()
    {
      this.map_desc = KNewShadowMapDescriptionDirectionalBasic.getDefault();
      this.factor_min = 0.1f;
      this.depth_bias = 0.001f;
    }

    Builder(
      final KNewShadowDirectionalMappedBasic b)
    {
    ...
    @Override public KNewShadowDirectionalMappedBasic build()
    {
      return new KNewShadowDirectionalMappedBasic(
        this.map_desc,
        this.depth_bias,
        this.factor_min);
    }
  ...
  private static final KNewShadowDirectionalMappedBasic DEFAULT;
  ...
  public static KNewShadowDirectionalMappedBasic getDefault()
  {
    return KNewShadowDirectionalMappedBasic.DEFAULT;
  }
  ...
  public static KNewShadowDirectionalMappedBasicBuilderType newBuilder()
  {
    return new Builder();
  }
  ...
  public static KNewShadowDirectionalMappedBasicBuilderType newBuilderFrom(
  ...
  private final KNewShadowMapDescriptionDirectionalBasic map_description;

  private KNewShadowDirectionalMappedBasic(
    final KNewShadowMapDescriptionDirectionalBasic in_map_description,
    ...
    @Nullable final Object obj)
  {
    ...
    final KNewShadowDirectionalMappedBasic other =
      (KNewShadowDirectionalMappedBasic) obj;
  ...
  public KNewShadowMapDescriptionDirectionalBasic getMapDescription()
  {
