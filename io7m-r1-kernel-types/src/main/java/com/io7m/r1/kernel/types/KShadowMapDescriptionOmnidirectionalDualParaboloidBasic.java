...
/**
 * The type of descriptions for omnidirectional (dual paraboloid) basic shadow
 * maps.
 */

@SuppressWarnings("synthetic-access") @EqualityStructural public final class KShadowMapDescriptionOmnidirectionalDualParaboloidBasic implements
  KShadowMapDescriptionOmnidirectionalType
{
  @EqualityReference private static final class Builder implements
    KShadowMapDescriptionOmnidirectionalDualParaboloidBasicBuilderType
  {
    ...
    Builder(
      final KShadowMapDescriptionOmnidirectionalDualParaboloidBasic d)
    {
      ...
      build()
    {
      ...
      return new KShadowMapDescriptionOmnidirectionalDualParaboloidBasic(
        this.exponent,
        area,
        this.filter_mag,
        this.filter_min,
  ...
  private static final KShadowMapDescriptionOmnidirectionalDualParaboloidBasic DEFAULT;
  ...
  public static
    ...
    getDefault()
  {
    return KShadowMapDescriptionOmnidirectionalDualParaboloidBasic.DEFAULT;
  }
  ...
  private KShadowMapDescriptionOmnidirectionalDualParaboloidBasic(
    ...
    @Nullable final Object obj)
  {
    ...
    final KShadowMapDescriptionOmnidirectionalDualParaboloidBasic other =
      (KShadowMapDescriptionOmnidirectionalDualParaboloidBasic) obj;
