...
@SuppressWarnings("synthetic-access") @EqualityStructural public final class KShadowMapDescriptionOmnidirectionalCubeBasic implements
  KShadowMapDescriptionOmnidirectionalType
{
  @EqualityReference private static final class Builder implements
    KShadowMapDescriptionOmnidirectionalCubeBasicBuilderType
  {
    ...
    Builder(
      final KShadowMapDescriptionOmnidirectionalCubeBasic d)
    {
    ...
    @Override public KShadowMapDescriptionOmnidirectionalCubeBasic build()
    {
      final RangeInclusiveL range =
        new RangeInclusiveL(0, (long) (Math.pow(2, this.exponent) - 1));
      final AreaInclusive area = new AreaInclusive(range, range);
      return new KShadowMapDescriptionOmnidirectionalCubeBasic(
        this.exponent,
        area,
        this.filter_mag,
        this.filter_min,
  ...
  private static final KShadowMapDescriptionOmnidirectionalCubeBasic DEFAULT;

  static {
    DEFAULT =
      KShadowMapDescriptionOmnidirectionalCubeBasic.newBuilder().build();
  }
  ...
  public static KShadowMapDescriptionOmnidirectionalCubeBasic getDefault()
  {
    return KShadowMapDescriptionOmnidirectionalCubeBasic.DEFAULT;
  }
  ...
  private KShadowMapDescriptionOmnidirectionalCubeBasic(
    ...
    @Nullable final Object obj)
  {
    ...
    final KShadowMapDescriptionOmnidirectionalCubeBasic other =
      (KShadowMapDescriptionOmnidirectionalCubeBasic) obj;
  ...
  @Override public
    ...
    T
    shadowMapDescriptionOmnidirectionalAccept(
      final KShadowMapDescriptionOmnidirectionalVisitorType<T, E> v)
      throws E,
        JCGLException,
        RException
  {
