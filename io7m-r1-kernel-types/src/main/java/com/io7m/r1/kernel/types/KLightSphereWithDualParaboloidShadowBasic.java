...
@EqualityReference public final class KLightSphereWithDualParaboloidShadowBasic implements
  KLightSphereType,
  KLightWithShadowType
{
  @SuppressWarnings("synthetic-access") @EqualityReference private static final class Builder implements
    KLightSphereWithDualParaboloidShadowBuilderType
  {
    ...
    private KShadowOmnidirectionalDualParaboloidMappedBasic shadow;
    ...
    Builder(
      final KLightSphereWithDualParaboloidShadowBasic in_original)
    {
    ...
    @Override public KLightSphereWithDualParaboloidShadowBasic build()
    {
      return new KLightSphereWithDualParaboloidShadowBasic(
        this.color,
        this.intensity,
        this.position,
        this.radius,
  ...
  /**
   * The near plane used for rendering shadows.
   */

  public static final float SHADOW_NEAR_PLANE;

  static {
    SHADOW_NEAR_PLANE = 0.0001f;
  }
  ...
  public static KLightSphereWithDualParaboloidShadowBuilderType newBuilder()
  {
    return new Builder();
  }
  ...
  public static KLightSphereWithDualParaboloidShadowBasic newLight(
    final RVectorI3F<RSpaceRGBType> in_color,
    final float in_intensity,
    final RVectorI3F<RSpaceWorldType> in_position,
    final float in_radius,
    final float in_falloff,
    final KShadowOmnidirectionalDualParaboloidMappedBasic in_shadow)
  {
    return new KLightSphereWithDualParaboloidShadowBasic(
      in_color,
      in_intensity,
  ...
  private final KShadowOmnidirectionalDualParaboloidMappedBasic                   shadow;
  private final KTransformType                                                    transform;

  private KLightSphereWithDualParaboloidShadowBasic(
    final RVectorI3F<RSpaceRGBType> in_color,
  ...
  public
    KShadowOmnidirectionalDualParaboloidMappedBasic
    lightGetShadowDualParaboloidMappedBasic()
  {
    return this.shadow;
  }
  ...
  /**
   * Produce a view matrix for producing a dual paraboloid shadow map. The
   * matrix produced is for the negative Z hemisphere.
   *
   * @param m
   *          The produced matrix.
   */

  public void lightProduceViewMatrixNegativeZ(
    final MatrixM4x4F m)
  {
    final float px = this.position.getXF();
    final float py = this.position.getYF();
    final float pz = this.position.getZF();

    final VectorI3F target_pz = new VectorI3F(px, py, pz - 1.0f);
    MatrixM4x4F.setIdentity(m);
    ViewMatrix.lookAt(m, this.position, target_pz, KAxes.AXIS_Y);
  }

  /**
   * Produce a view matrix for producing a dual paraboloid shadow map. The
   * matrix produced is for the positive Z hemisphere.
   *
   * @param m
   *          The produced matrix.
   */

  public void lightProduceViewMatrixPositiveZ(
    final MatrixM4x4F m)
  {
    final float px = this.position.getXF();
    final float py = this.position.getYF();
  ...
  @Override public <A, E extends Throwable> A sphereAccept(
    ...
    throws RException,
      E
  {
    return v.sphereWithDualParaboloidShadowBasic(this);
  }
  ...
  @Override public String toString()
  {
    ...
    b.append("[KLightSphereWithDualParaboloidShadowBasic color=");
    b.append(this.color);
    b.append(", falloff=");
  ...
  @Override public <A, E extends Throwable> A withShadowAccept(
    ...
    throws RException,
      ...
      JCGLException
  {
    return v.sphereWithShadowBasic(this);
  }
}
