...
public interface KShadowMapDescriptionOmnidirectionalDualParaboloidBasicBuilderType extends
  KShadowMapDescriptionBuilderType
{
  ...
  KShadowMapDescriptionOmnidirectionalDualParaboloidBasic build();
}
