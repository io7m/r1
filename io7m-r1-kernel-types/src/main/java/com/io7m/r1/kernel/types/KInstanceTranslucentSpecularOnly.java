...
/**
 * A mesh with a specular-only material ( {@link KMesh}), with a specific
 * transform and texture matrix.
 */

@EqualityReference public final class KInstanceTranslucentSpecularOnly implements
  KInstanceTranslucentLitType
{
  ...
  @Override public String toString()
  {
    ...
    b.append("[KInstanceTranslucentSpecularOnly faces=");
    b.append(this.faces);
    b.append(" material=");
