...
@EqualityStructural public final class KBilateralBlurParameters
{
  private static final KBilateralBlurParameters DEFAULT;

  static {
    DEFAULT = KBilateralBlurParameters.makeDefault();
  }
  ...
  public static KBilateralBlurParameters getDefault()
  {
    return KBilateralBlurParameters.DEFAULT;
  }

  private static KBilateralBlurParameters makeDefault()
  {
    return KBilateralBlurParameters.newBuilder().build();
  }
  ...
  public static KBilateralBlurParametersBuilderType newBuilder()
  {
    return new KBilateralBlurParametersBuilderType() {
      private float blur_size = 1.0f;
      private int   passes    = 1;
      private float scale     = 1.0f;

      @SuppressWarnings("synthetic-access") @Override public
        KBilateralBlurParameters
        build()
      {
        return new KBilateralBlurParameters(
          this.blur_size,
          this.scale,
          this.passes);
      }
  ...
  private KBilateralBlurParameters(
    ...
    final @Nullable Object obj)
  {
    ...
    final KBilateralBlurParameters other = (KBilateralBlurParameters) obj;
  ...
  @Override public String toString()
  {
    ...
    s.append("[KBilateralBlurParameters blur_size=");
