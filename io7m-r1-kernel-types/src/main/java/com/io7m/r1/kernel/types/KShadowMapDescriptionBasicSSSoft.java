...
/**
 * The type of descriptions for directional basic shadow maps with
 * screen-space blurring.
 */

@SuppressWarnings("synthetic-access") @EqualityStructural public final class KShadowMapDescriptionBasicSSSoft implements
  KShadowMapDescriptionType
{
  @EqualityReference private static final class Builder implements
    KShadowMapDescriptionBasicSSSoftBuilderType
  {
    ...
    Builder(
      final KShadowMapDescriptionBasicSSSoft d)
    {
  ...
  private static final KShadowMapDescriptionBasicSSSoft DEFAULT;

  static {
    DEFAULT = KShadowMapDescriptionBasicSSSoft.newBuilder().build();
  }
  ...
  public static KShadowMapDescriptionBasicSSSoft getDefault()
  {
    return KShadowMapDescriptionBasicSSSoft.DEFAULT;
  }
  ...
  public static KShadowMapDescriptionBasicSSSoftBuilderType newBuilder()
  {
    return new Builder();
  }
  ...
  public static KShadowMapDescriptionBasicSSSoftBuilderType newBuilderFrom(
    final KShadowMapDescriptionBasicSSSoft d)
  {
  ...
  private KShadowMapDescriptionBasicSSSoft(
    ...
    @Nullable final Object obj)
  {
    ...
    final KShadowMapDescriptionBasicSSSoft other =
      (KShadowMapDescriptionBasicSSSoft) obj;
  ...
  @Override public String toString()
  {
    ...
    b.append("[KShadowMapDescriptionBasicSSSoft framebuffer_desc=");
