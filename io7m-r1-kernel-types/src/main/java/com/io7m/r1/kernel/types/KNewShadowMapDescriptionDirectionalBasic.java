...
@SuppressWarnings("synthetic-access") @EqualityStructural public final class KNewShadowMapDescriptionDirectionalBasic implements
  KNewShadowMapDescriptionDirectionalType
{
  @EqualityReference private static final class Builder implements
    KNewShadowMapDescriptionDirectionalBasicBuilderType
  {
    ...
    Builder(
      final KNewShadowMapDescriptionDirectionalBasic d)
    {
    ...
    @Override public KNewShadowMapDescriptionDirectionalBasic build()
    {
      final RangeInclusiveL range =
        new RangeInclusiveL(0, (long) (Math.pow(2, this.exponent) - 1));
      final AreaInclusive area = new AreaInclusive(range, range);
      return new KNewShadowMapDescriptionDirectionalBasic(
        this.exponent,
        area,
        this.filter_mag,
        this.filter_min,
  ...
  private static final KNewShadowMapDescriptionDirectionalBasic DEFAULT;

  static {
    DEFAULT = KNewShadowMapDescriptionDirectionalBasic.newBuilder().build();
  }
  ...
  public static KNewShadowMapDescriptionDirectionalBasic getDefault()
  {
    return KNewShadowMapDescriptionDirectionalBasic.DEFAULT;
  }
  ...
  private KNewShadowMapDescriptionDirectionalBasic(
    ...
    @Nullable final Object obj)
  {
    ...
    final KNewShadowMapDescriptionDirectionalBasic other =
      (KNewShadowMapDescriptionDirectionalBasic) obj;
