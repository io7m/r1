...
@EqualityStructural public final class KMeshReduced implements
  KMeshReducedReadableType,
  ...
  JCGLResourceSizedType
{
      ...
      RExceptionMeshMissingPositions
  {
    ...
    if (KMeshReduced.hasPositions(as) == false) {
      throw RExceptionMeshMissingPositions.fromArray(this.array);
    }
    if (KMeshReduced.hasUVs(as) == false) {
    ...
    final @Nullable Object obj)
  {
    ...
    final KMeshReduced other = (KMeshReduced) obj;
