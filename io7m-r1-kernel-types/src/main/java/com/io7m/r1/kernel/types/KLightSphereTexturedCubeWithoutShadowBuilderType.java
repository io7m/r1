...
public interface KLightSphereTexturedCubeWithoutShadowBuilderType extends
  KLightSphereBuilderType
{
  ...
  KLightSphereTexturedCubeWithoutShadow build();
   ...
   *
   * @param orientation
   *          The orientation for the light texture.
   */
