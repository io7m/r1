...
public interface KShadowDirectionalMappedVarianceBuilderType extends
  KShadowBuilderType, KShadowMappedVarianceBuilderType
{
  /**
   * @return A shadow based on the most recently given parameters.
   */

  KShadowDirectionalMappedVariance build();
