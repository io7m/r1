...
@EqualityReference public final class KLightProjectiveWithShadowBasicSSSoftDiffuseOnly implements
  KLightProjectiveWithShadowBasicSSSoftType
{
  @SuppressWarnings("synthetic-access") @EqualityReference private static final class Builder implements
    KLightProjectiveWithShadowBasicSSSoftDiffuseOnlyBuilderType
  {
    ...
    @Override public KLightProjectiveWithShadowBasicSSSoftDiffuseOnly build()
      throws RException
    {
      return new KLightProjectiveWithShadowBasicSSSoftDiffuseOnly(
        this.texture,
        this.position,
        this.orientation,
        this.color,
  ...
  private KLightProjectiveWithShadowBasicSSSoftDiffuseOnly(
    final Texture2DStaticUsableType in_texture,
    final PVectorI3F<RSpaceWorldType> in_position,
    final QuaternionI4F in_orientation,
    final PVectorI3F<RSpaceRGBType> in_color,
    ...
    final KShadowMappedBasicSSSoft in_shadow)
  {
    ...
    this.transform =
      KTransformOST.newTransform(
        this.orientation,
        KLightProjectiveWithShadowBasicSSSoftDiffuseOnly.ONE,
        this.position);
  ...
  {
    return "LProjSMBasicSSSoftDiffuseOnly";
  }
  ...
  @Override public
    ...
    projectiveAccept(
      ...
      throws RException,
        E
  {
    return v.projectiveWithShadowBasicSSSoftDiffuseOnly(this);
  }
