...
/**
 * Access to the matrices for a given spherical light with dual paraboloid
 * shadow mapping.
 */

public interface KMatricesSphericalDualParaboloidValuesType extends
  KMatricesObserverValuesType
{
  /**
   * @return The current model matrix for the light
   */

  RMatrixReadable4x4FType<RTransformModelType> getMatrixModel();

  /**
   * @return The current model-view matrix for the light
   */

  RMatrixReadable4x4FType<RTransformModelViewType> getMatrixModelView();

  /**
   * @return The current normal matrix for the light
   */

  RMatrixReadable3x3FType<RTransformNormalType> getMatrixNormal();

  /**
   * @return The current UV matrix for the light
   */

  RMatrixM3x3F<RTransformTextureType> getMatrixUV();

  /**
   * @return The current (eye → world → light eye) matrix for the light
   */
