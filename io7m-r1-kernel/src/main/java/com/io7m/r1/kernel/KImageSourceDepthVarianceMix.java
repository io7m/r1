...
@EqualityReference public final class KImageSourceDepthVarianceMix implements
  KImageSourceDepthVarianceType<KTextureMixParameters>
{
  ...
  {
    return new KImageSourceDepthVarianceMix(gi, quad_cache, shader_cache);
  }
  ...
  private KImageSourceDepthVarianceMix(
    ...
    throws RException
  {
    try {
      ...
      final KUnitQuadUsableType quad =
        KImageSourceDepthVarianceMix.this.quad_cache.cacheGetLU(Unit.unit());
      ...
      try {
        final RMatrixM3x3F<RTransformTextureType> m_uv =
          KImageSourceDepthVarianceMix.this.uv;
  ...
  @Override public void sourceEvaluateDepthVariance(
    final KTextureMixParameters config,
        ...
        e.execRun(new JCBExecutorProcedureType<RException>() {
          @SuppressWarnings("synthetic-access") @Override public void call(
            ...
            throws JCGLException,
              RException
          {
            KImageSourceDepthVarianceMix.this.evaluate(gc, config, jp);
          }
        });
      } finally {
