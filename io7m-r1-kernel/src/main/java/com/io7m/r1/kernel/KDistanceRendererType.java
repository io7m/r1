...
/**
 * <p>
 * The type of distance renderers.
 * </p>
 * <p>
 * A distance renderer will produce an image with each pixel corresponding to
 * the eye-space distance (from the observer) of the surface producing the
 * pixel.
 * </p>
 */

public interface KDistanceRendererType extends KRendererType
{
  /**
   * Bind the given framebuffer and then call
   * {@link #rendererEvaluateDistanceWithBoundFramebuffer(PMatrixI4x4F, KProjectionType, KDepthInstancesType, AreaInclusive, OptionType)}
   * .
   *
   * @param view
  ...
  void rendererEvaluateDistanceWithBoundFramebuffer(
    final PMatrixI4x4F<RSpaceWorldType, RSpaceEyeType> view,
    final KProjectionType projection,
    final KDepthInstancesType instances,
