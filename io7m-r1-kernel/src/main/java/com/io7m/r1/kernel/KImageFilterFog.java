...
@EqualityReference final class KImageFilterFog implements
  KImageFilterRGBAWithDepthType<KFogParameters>
{
  ...
  public static KImageFilterFog filterNew(
  ...
  {
    this.log = NullCheck.notNull(in_log, "Log").with(KImageFilterFog.NAME);
            ...
            RException
        {
          try {
            final KUnitQuadUsableType quad =
              KImageFilterFog.this.quad_cache.cacheGetLU(Unit.unit());
            ...
            p.programUniformPutVector3f(
              "fog.color",
              KImageFilterFog.this.fog_color);
  ...
  @Override public <A, E extends Throwable> A filterAccept(
    ...
    throws RException,
      E
  {
    return v.rgbaWithDepth(this);
  }

  @Override public
    <F extends KFramebufferRGBAUsableType & KFramebufferDepthUsableType>
    void
    filterEvaluateRGBAWithDepth(
