...
/**
 * The type of filters that operate on monochrome values.
 *
 * @param <C>
 *          The type of renderer-specific configuration values
 */

public interface KImageFilterMonochromeType<C> extends KImageFilterType
{
  /**
   * <p>
