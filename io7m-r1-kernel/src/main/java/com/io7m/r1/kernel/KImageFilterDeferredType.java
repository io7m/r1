...
/**
 * The type of filters that operate on deferred framebuffers.
 *
 * @param <C>
 *          The type of renderer-specific configuration values
 */

public interface KImageFilterDeferredType<C> extends KImageFilterType
{
  /**
   * <p>
