...
/**
 * The type of filters that operate on depth values.
 *
 * @param <C>
 *          The type of renderer-specific configuration values
 */

public interface KImageFilterDepthType<C> extends KImageFilterType
{
  /**
   * <p>
  ...
  void filterEvaluateDepth(
    final C config,
    final KFramebufferDepthUsableType input,
    final KFramebufferDepthUsableType output)
    throws RException;
}
