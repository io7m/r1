...
@EqualityReference public final class KNewShadowMapDirectionalBasic implements
  KNewShadowMapDirectionalType
{
  ...
  public static KNewShadowMapDirectionalBasic newMap(
    final JCGLImplementationType g,
    final KNewShadowMapDescriptionDirectionalBasic description)
    throws RException
  {
    ...
    return new KNewShadowMapDirectionalBasic(description, f);
  }

  private final KNewShadowMapDescriptionDirectionalBasic description;
  private final KFramebufferDepth                        framebuffer;

  private KNewShadowMapDirectionalBasic(
    final KNewShadowMapDescriptionDirectionalBasic in_description,
  ...
  public KNewShadowMapDescriptionDirectionalBasic getDescription()
  {
