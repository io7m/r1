...
/**
 * The type of postprocessors that operate on depth framebuffers and write
 * their results to RGBA framebuffers.
 *
 * @param <C>
 *          The type of renderer-specific configuration values
 */

public interface KPostprocessorDepthRGBAType<C> extends KPostprocessorType
{
  /**
   * <p>
  ...
  void postprocessorEvaluateDepthRGBA(
    final C config,
