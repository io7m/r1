...
/**
 * The type of usable "image-only" monochrome framebuffers.
 */

public interface KFramebufferMonochromeUsableType extends
  KFramebufferUsableType
{
  ...
  FramebufferUsableType getMonochromeFramebuffer();
  ...
  KFramebufferMonochromeDescription getMonochromeDescription();

  /**
   * <p>
   * Retrieve the texture that backs the scene framebuffer.
   * </p>
   *
   * @return A reference to the texture that backs the color buffer
   */

  Texture2DStaticUsableType getMonochromeTexture();
}
