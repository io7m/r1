...
/**
 * The type of usable distance-renderable framebuffers.
 */

public interface KFramebufferDistanceUsableType extends
  KFramebufferUsableType
{
  ...
  KFramebufferDistanceDescription getDistanceDescription();
  ...
  FramebufferUsableType getDistancePassFramebuffer();

  /**
   * <p>
   * Retrieve the current depth values of the scene as a texture.
   * </p>
   *
   * @return A reference to the texture that backs the depth buffer
   */

  Texture2DStaticUsableType getDistanceDepthTexture();
  ...
  Texture2DStaticUsableType getDistanceTexture();
}
