...
/**
 * The type of postprocessors that operate on deferred framebuffers.
 *
 * @param <C>
 *          The type of renderer-specific configuration values
 */

public interface KPostprocessorDeferredType<C> extends KPostprocessorType
{
  /**
   * <p>
  ...
  void postprocessorEvaluateDeferred(
    final C config,
