...
/**
 * The type of filters that operate on depth-variance values.
 *
 * @param <C>
 *          The type of renderer-specific configuration values
 */

public interface KImageFilterDepthVarianceType<C> extends KImageFilterType
{
  /**
   * <p>
  ...
  void filterEvaluateDepthVariance(
    final C config,
