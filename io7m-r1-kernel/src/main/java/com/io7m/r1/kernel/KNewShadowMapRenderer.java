...
@SuppressWarnings("synthetic-access") @EqualityReference public final class KNewShadowMapRenderer implements
  KNewShadowMapRendererType
{
  ...
  public static KNewShadowMapRendererType newRenderer(
    ...
    final KNewShadowMapCacheType in_shadow_cache,
    final LogUsableType in_log)
  {
    return new KNewShadowMapRenderer(
      gl,
      in_depth_renderer,
  ...
  private static void renderProjectiveBasic(
    ...
    final KNewShadowMapDirectionalBasic sm)
  ...
  private static void renderProjectiveVariance(
    ...
    final KNewShadowMapDirectionalVariance sm)
    throws JCGLException,
      RException
  {
    final KNewShadowDirectionalMappedVariance shadow =
  ...
  private static
    void
    returnReceipts(
      final Map<KLightWithShadowType, BLUCacheReceiptType<KNewShadowMapDescriptionType, KNewShadowMapUsableType>> receipts)
  {
    for (final KLightWithShadowType light : receipts.keySet()) {
      assert light != null;

      final BLUCacheReceiptType<KNewShadowMapDescriptionType, KNewShadowMapUsableType> r =
        receipts.get(light);
      r.returnToCache();
    }
  }
  ...
  private final KNewShadowMapCacheType              shadow_cache;

  private KNewShadowMapRenderer(
    final JCGLImplementationType gl,
    final KDepthRendererType in_depth_renderer,
    final KDepthVarianceRendererType in_depth_variance_renderer,
    final KPostprocessorBlurDepthVarianceType in_blur,
  ...
  @Override public <A, E extends Throwable> A rendererEvaluateShadowMaps(
    ...
    final KNewShadowMapWithType<A, E> with)
    throws E,
      RException
  {
    ...
    try {
      ...
      final Map<KLightWithShadowType, BLUCacheReceiptType<KNewShadowMapDescriptionType, KNewShadowMapUsableType>> receipts =
        new HashMap<KLightWithShadowType, BLUCacheReceiptType<KNewShadowMapDescriptionType, KNewShadowMapUsableType>>();
      ...
      try {
        this.matrices.withObserver(
          ...
          new KMatricesObserverFunctionType<Unit, JCGLException>() {
            ...
            {
              try {
                KNewShadowMapRenderer.this.shadowMapsRenderAll(
                  batches_by_light,
                  lights,
                  receipts,
                  mo);
        ...
        final A r = with.withMaps(new KNewShadowMapContextType() {
          @Override public KNewShadowMapUsableType getShadowMap(
            final KLightWithShadowType light)
            throws RException
          {
            assert receipts.containsKey(light);
            final BLUCacheReceiptType<KNewShadowMapDescriptionType, KNewShadowMapUsableType> rr =
              receipts.get(light);
            assert rr != null;
            return rr.getValue();
          }
        ...
        KNewShadowMapRenderer.returnReceipts(receipts);
      }
  ...
  {
    return KNewShadowMapRenderer.NAME;
  }
  ...
  private
    ...
    shadowMapsRenderAll(
      ...
      throws RException,
        ...
        JCGLException
  {
    final KNewShadowMapCacheType sc = this.shadow_cache;
        ...
        .withShadowAccept(new KLightWithShadowVisitorType<Unit, JCacheException>() {
          @Override public Unit projectiveWithShadowBasic(
            ...
            throws RException,
              ...
              JCGLException
          {
            final KNewShadowDirectionalMappedBasic shadow =
              lp.lightGetShadowBasic();
            final KNewShadowMapDescriptionDirectionalBasic desc =
            ...
            final KNewShadowMapDirectionalBasic sm =
              (KNewShadowMapDirectionalBasic) r.getValue();
                ...
                new KMatricesProjectiveLightFunctionType<Unit, JCGLException>() {
                  @Override public Unit run(
                    ...
                    throws JCGLException,
                      RException
                  {
                    KNewShadowMapRenderer.renderProjectiveBasic(
                      gc,
                      mwp,
                      casters,
                      dr,
              ...
              JCGLException
          {
            final KNewShadowDirectionalMappedVariance shadow =
              lp.lightGetShadowVariance();
            final KNewShadowMapDescriptionDirectionalVariance desc =
              shadow.getMapDescription();
            final BLUCacheReceiptType<KNewShadowMapDescriptionType, KNewShadowMapUsableType> r =
              sc.bluCacheGet(desc);
            ...
            final KNewShadowMapDirectionalVariance sm =
              (KNewShadowMapDirectionalVariance) r.getValue();
                ...
                new KMatricesProjectiveLightFunctionType<Unit, JCGLException>() {
                  @Override public Unit run(
                    ...
                    throws JCGLException,
                      RException
                  {
                    KNewShadowMapRenderer.renderProjectiveVariance(
                      gc,
                      mwp,
                      casters,
                      dvr,
