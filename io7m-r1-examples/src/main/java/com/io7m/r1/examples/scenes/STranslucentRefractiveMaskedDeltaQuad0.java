...
public final class STranslucentRefractiveMaskedDeltaQuad0 implements
  ExampleSceneType
{
  /**
  ...
  public STranslucentRefractiveMaskedDeltaQuad0()
  {
    ...
    throws RException
  {
    final KTransformType mt =
      KTransformOST.newTransform(
        QuaternionI4F.makeFromAxisAngle(KAxes.AXIS_X, Math.toRadians(90.0)),
        new VectorI3F(1.0f, 1.0f, 1.0f),
        new PVectorI3F<RSpaceWorldType>(0.0f, 1.5f, 1.0f));
    ...
    m_trbb.setRefractive(KMaterialRefractiveMaskedDeltaTextured.create(
      0.05f,
