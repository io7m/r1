...
/**
 * The {@link DLSimple1} example with a diffuse-only light.
 */

public final class DLSimpleDiffuseOnly1 implements ExampleSceneType
{
  /**
   * Construct the example.
   */

  public DLSimpleDiffuseOnly1()
  {
