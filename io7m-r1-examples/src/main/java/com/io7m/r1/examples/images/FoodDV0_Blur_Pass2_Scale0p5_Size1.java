...
public final class FoodDV0_Blur_Pass2_Scale0p5_Size1 implements
  ExampleImageType
{
  /**
  ...
  public FoodDV0_Blur_Pass2_Scale0p5_Size1()
  {
    ...
    throws RException
  {
    ...
    final BLUCacheReceiptType<KFramebufferDepthVarianceDescription, KFramebufferDepthVarianceUsableType> rr0 =
      DepthVarianceExampleUtilities.makeFoodTexture(image, r1);
    final BLUCacheReceiptType<KFramebufferDepthVarianceDescription, KFramebufferDepthVarianceUsableType> rr1 =
...

    {
      ...
      blur.filterEvaluateDepthVariance(
        blur_config,
        rr0.getValue(),
        rr1.getValue());
    }
