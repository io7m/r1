...
/**
 * The {@link SLSpecular1} example with a diffuse-only light.
 */

public final class SLSpecularDiffuseOnly1 implements ExampleSceneType
{
  /**
   * Construct the example.
   */

  public SLSpecularDiffuseOnly1()
  {
...

    {
      final KMaterialOpaqueRegularBuilderType b =
        KMaterialOpaqueRegular
          .newBuilder(ExampleSceneUtilities.OPAQUE_GLOSS_PLASTIC_RED);
