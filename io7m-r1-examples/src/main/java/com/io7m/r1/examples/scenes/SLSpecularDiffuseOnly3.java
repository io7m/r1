...
/**
 * The {@link SLSpecular3} example with a diffuse-only light.
 */

public final class SLSpecularDiffuseOnly3 implements ExampleSceneType
{
  /**
   * Construct the example.
   */

  public SLSpecularDiffuseOnly3()
  {
