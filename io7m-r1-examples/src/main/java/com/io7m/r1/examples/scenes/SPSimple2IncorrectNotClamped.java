...
public final class SPSimple2IncorrectNotClamped implements ExampleSceneType
{
  ...
  public SPSimple2IncorrectNotClamped()
  {
    ...
    throws RException
  {
    ...
    final Texture2DStaticUsableType tp = scene.texture("projective.png");
