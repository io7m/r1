...
public final class STranslucentRefractiveMaskedNormals1 implements
  ExampleSceneType
{
  /**
  ...
  public STranslucentRefractiveMaskedNormals1()
  {
    ...
    throws RException
  {
    ...
    m_trbb.setNormalTexture(scene.texture("sea_tile_normal.png"));
    m_trbb.setRefractive(KMaterialRefractiveMaskedNormals.create(
      1.0f,
