...
/**
 * The {@link SPSimpleSpecular0} example with diffuse-only lighting.
 */

public final class SPSimpleSpecularDiffuseOnly0 implements ExampleSceneType
{
  ...
  public SPSimpleSpecularDiffuseOnly0()
  {
    ...
    throws RException
  {
    ...
    final KLightProjectiveWithoutShadowDiffuseOnly kp0 = b.build();
