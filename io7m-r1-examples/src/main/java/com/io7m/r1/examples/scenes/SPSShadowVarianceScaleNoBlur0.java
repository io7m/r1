...
public final class SPSShadowVarianceScaleNoBlur0 implements ExampleSceneType
{
  ...
  public SPSShadowVarianceScaleNoBlur0()
  {
    ...
    throws RException
  {
    ...
    final KShadowMappedVariance ks =
      SPSShadowVarianceScaleNoBlur0.makeShadow();
