...
public final class SLEmission0 implements ExampleSceneType
{
    ...
    throws RException
  {
    ...
    room_mat_b.setSpecularColor3f(0.15f, 0.15f, 0.15f);
    room_mat_b.setSpecularExponent(16.0f);
    ...
    material_b.setAlbedoTexture(scene.texture("emitcube_albedo.png"));
    material_b.setNormalTexture(scene.texture("emitcube_normal.png"));
    material_b.setEmission(1.0f);
    material_b.setEmissionTexture(scene.texture("emitcube_emissive.png"));
    material_b.setSpecularColor3f(0.0f, 0.0f, 1.0f);
    material_b.setSpecularExponent(4.0f);
    material_b.setSpecularTexture(scene.texture("emitcube_specular.png"));
