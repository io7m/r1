...
public final class DemoRoom0Ortho implements ExampleSceneType
{
  /**
   * Construct the example.
   */

  public DemoRoom0Ortho()
  {
  ...
  {
    final List<ExampleViewType> v0 = new ArrayList<ExampleViewType>();
    ...
    for (final ExampleViewType v : v0) {
      ...
      v1.add(new ExampleViewType() {
        @Override public KCamera getCamera()
        {
          return KCamera.newCamera(vc.getViewMatrix(), p);
        }
      });
    }
    return v1;
