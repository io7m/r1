...
/**
 * The opaque version of {@link STranslucent1}.
 */

public final class SOpaque1 implements ExampleSceneType
{
  /**
    ...
    throws RException
  {
    ...
    final KMaterialOpaqueRegular glass_mat;
    {
      final KMaterialOpaqueRegularBuilderType b =
        KMaterialOpaqueRegular.newBuilder(utilities.getMaterialDefaults());
    ...
    final KInstanceOpaqueRegular glass =
      KInstanceOpaqueRegular.newInstance(
        scene.mesh("plane2x2.rmx"),
        glass_mat,
        glass_trans,
...

    {
      ...
      b.setPosition(new PVectorI3F<RSpaceWorldType>(-1.5f, 0.8f, -1.0f));
      l0 = b.build();
