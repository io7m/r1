...
public final class SPSShadowVarianceSpecularDiffuseOnly0 implements
  ExampleSceneType
{
  ...
  public SPSShadowVarianceSpecularDiffuseOnly0()
  {
    ...
    throws RException
  {
    ...
    final KShadowMappedVariance ks =
      SPSShadowVarianceSpecularDiffuseOnly0.makeShadow();
