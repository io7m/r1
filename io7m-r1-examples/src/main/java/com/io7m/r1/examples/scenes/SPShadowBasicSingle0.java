...
/**
 * An example with projective lighting and basic shadow mapping, where the
 * only existing light has shadow casters assigned.
 */

public final class SPShadowBasicSingle0 implements ExampleSceneType
{
