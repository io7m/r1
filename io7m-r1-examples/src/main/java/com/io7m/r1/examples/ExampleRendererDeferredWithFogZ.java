...
public final class ExampleRendererDeferredWithFogZ implements
  ExampleRendererDeferredType
{
      ...
      @SuppressWarnings("synthetic-access") @Override public
        ...
        newRenderer(
          ...
          throws JCGLException,
            RException
      {
        return ExampleRendererDeferredWithFogZ.make(log, caches, gi);
      }
    };
  }
  ...
  {
    final String name = ExampleRendererDeferredWithFogZ.class.getSimpleName();
      ...
      RException
  {
    ...
    final KRendererDeferredType r_with_e = new KRendererDeferredType() {
          ...
          throws RException
      {
        ...
        fog_b.setFarZ(far);
        fog_b.setColor(grey);
        final KFogZParameters config = fog_b.build();
      ...
      {
        final String name =
          ExampleRendererDeferredWithFogZ.class.getCanonicalName();
        return NullCheck.notNull(name);
      }
    };

    return new ExampleRendererDeferredWithFogZ(r, r_with_e);
  }

  private final KRendererDeferredType actual;
  private final R1Type                r1;

  private ExampleRendererDeferredWithFogZ(
    final R1Type in_r1,
