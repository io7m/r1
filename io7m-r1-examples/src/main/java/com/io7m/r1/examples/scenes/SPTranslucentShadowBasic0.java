...
public final class SPTranslucentShadowBasic0 implements ExampleSceneType
{
  ...
  public SPTranslucentShadowBasic0()
  {
    ...
    throws RException
  {
    ...
    /**
     * An opaque shadow-casting monkey. Not displayed, but present for shadow
     * casting.
     */
    ...
    /**
     * A translucent monkey.
     */

    final KMaterialTranslucentRegularBuilderType mtb =
      KMaterialTranslucentRegular
        .newBuilder(ExampleSceneUtilities.TRANSLUCENT_MATTE_WHITE);
    mtb.setAlbedo(KMaterialAlbedoTextured.textured(
      ExampleSceneUtilities.RGBA_WHITE,
      1.0f,
      t));
    mtb.setAlpha(KMaterialAlphaConstant.constant(0.6f));

    final KInstanceTranslucentRegular mti =
    ...
    lights.add(kp0);
    scene.sceneAddTranslucentLit(mti, lights);
  }
