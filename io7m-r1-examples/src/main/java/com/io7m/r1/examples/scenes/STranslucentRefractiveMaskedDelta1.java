...
public final class STranslucentRefractiveMaskedDelta1 implements
  ExampleSceneType
{
  /**
  ...
  public STranslucentRefractiveMaskedDelta1()
  {
    ...
    throws RException
  {
    ...
    final KMaterialTranslucentRefractive m_trb = m_trbb.build();
