...
/**
 * The {@link SPShadowVarianceSpecular0} example with diffuse-only lighting.
 */

public final class SPShadowVarianceSpecularDiffuseOnly0 implements
  ExampleSceneType
{
  ...
  public SPShadowVarianceSpecularDiffuseOnly0()
  {
    ...
    throws RException
  {
    ...
    KLightSphereWithoutShadowDiffuseOnly ks;
    ...
    final KLightProjectiveWithShadowVarianceDiffuseOnly kp0;
    final KLightProjectiveWithShadowVarianceDiffuseOnly kp1;
    final KLightProjectiveWithShadowVarianceDiffuseOnly kp2;
