...
/**
 * An example with the viewer being outside of a spherical light source.
 */

public final class SLSimpleViewerOutsideOfLight0 implements ExampleSceneType
{
  /**
   * Construct the example.
   */

  public SLSimpleViewerOutsideOfLight0()
  {
