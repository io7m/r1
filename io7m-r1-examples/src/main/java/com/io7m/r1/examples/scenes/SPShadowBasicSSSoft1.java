...
public final class SPShadowBasicSSSoft1 implements ExampleSceneType
{
    ...
    throws RException
  {
    ...
    final KLightProjectiveWithShadowBasicSSSoft kp1;
    final KLightProjectiveWithShadowBasicSSSoft kp2;
