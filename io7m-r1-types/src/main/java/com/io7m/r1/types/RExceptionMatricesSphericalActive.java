 ...
 * cannot be used when a spherical light is already active.
 */

@EqualityReference public final class RExceptionMatricesSphericalActive extends
  RExceptionUserError
{
  ...
  public RExceptionMatricesSphericalActive(
