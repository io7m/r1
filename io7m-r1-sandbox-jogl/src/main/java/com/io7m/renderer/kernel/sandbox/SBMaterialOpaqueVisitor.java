...
public interface SBMaterialOpaqueVisitor<A, E extends Throwable>
{
  /**
  ...
  A materialVisitOpaqueAlphaDepth(
    final SBMaterialOpaqueAlphaToDepth m)
    throws RException,
      E;
  ...
  A materialVisitOpaqueRegular(
    final SBMaterialOpaqueRegular m)
    throws RException,
      E;
}
