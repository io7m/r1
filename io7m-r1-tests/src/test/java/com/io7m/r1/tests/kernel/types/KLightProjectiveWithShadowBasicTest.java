...
@SuppressWarnings("static-method") public final class KLightProjectiveWithShadowBasicTest
{
    ...
    throws Exception
  {
    ...
    final KLightProjectiveWithShadowBasicBuilderType b =
      KLightProjectiveWithShadowBasic.newBuilder(t, p);
    b.setRange(0.0f);
    b.build();
  }
  ...
  @Test public void testAttributes()
  {
    ...
    final KShadowDirectionalMappedBasicGenerator shad_gen =
    ...
    QuickCheck.forAllVerbose(
      gen,
      new AbstractCharacteristic<KLightProjectiveWithShadowBasic>() {
        @Override protected void doSpecify(
          final KLightProjectiveWithShadowBasic s)
          throws Throwable
        {
          {
            final KLightProjectiveWithShadowBasicBuilderType b =
