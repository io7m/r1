...
@SuppressWarnings("static-method") public final class KImageFilterEmissionGlowTest
{
    ...
    throws Exception
  {
    ...
    final KImageFilterDeferredType<KGlowParameters> f =
      r1.getFilterEmissionGlow();
    final KGlowParametersBuilderType bb = KGlowParameters.newBuilder();
    bb.setBlurSize(1.0f);
    bb.setPasses(1);
    bb.setFactor(1.0f);
    bb.setScale(1.0f);
    final KGlowParameters params = bb.build();
    f.filterEvaluateDeferred(params, fb, fb);
  }
