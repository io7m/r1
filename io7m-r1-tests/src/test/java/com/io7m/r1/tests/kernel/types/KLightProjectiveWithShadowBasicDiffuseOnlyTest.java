...
@SuppressWarnings("static-method") public final class KLightProjectiveWithShadowBasicDiffuseOnlyTest
{
  @Test public void testAttributes()
  {
    ...
    final Generator<KLightProjectiveWithShadowBasicDiffuseOnly> gen =
      new KLightProjectiveWithShadowBasicDiffuseOnlyGenerator(
        colour_gen1,
        position_gen1,
        qg,
        pg,
    ...
    QuickCheck
      .forAllVerbose(
        gen,
        new AbstractCharacteristic<KLightProjectiveWithShadowBasicDiffuseOnly>() {
          @Override protected void doSpecify(
            final KLightProjectiveWithShadowBasicDiffuseOnly s)
            throws Throwable
          {
            {
