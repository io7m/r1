...
@SuppressWarnings("static-method") public final class KImageFilterRGBABlurTest
{
    ...
    throws Exception
  {
...

    {
      ...
      blur.filterEvaluateRGBA(config, fb, fb);
    }
  ...
  @Test public void testParameters()
  {
    QuickCheck.forAllVerbose(
      new KBlurParametersGenerator(),
      new AbstractCharacteristic<KBlurParameters>() {
          ...
          throws Throwable
        {
          ...
          b.setBlurSize(p.getBlurSize());
          b.setPasses(p.getPasses());
          b.setScale(p.getScale());

          final KBlurParameters q = b.build();
