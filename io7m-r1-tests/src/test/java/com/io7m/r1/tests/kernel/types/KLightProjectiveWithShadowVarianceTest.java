...
@SuppressWarnings("static-method") public final class KLightProjectiveWithShadowVarianceTest
{
  ...
  @Test public void testAttributes()
  {
    ...
    final KShadowDirectionalMappedVarianceGenerator shad_gen =
      new KShadowDirectionalMappedVarianceGenerator();
    final Generator<KLightProjectiveWithShadowVariance> gen =
      new KLightProjectiveWithShadowVarianceGenerator(
        colour_gen1,
        position_gen1,
        qg,
        pg,
    ...
    QuickCheck.forAllVerbose(
      gen,
      new AbstractCharacteristic<KLightProjectiveWithShadowVariance>() {
        @Override protected void doSpecify(
          final KLightProjectiveWithShadowVariance s)
          throws Throwable
        {
          {
            final KLightProjectiveWithShadowVarianceBuilderType b =
              KLightProjectiveWithShadowVariance.newBuilderFrom(s);
            final float f = s.lightProjectiveGetFalloff() + 1.0f;
            b.setFalloff(f);
            final KLightProjectiveWithShadowVariance r = b.build();
...

          {
            ...
            b.setRange(r);
            final KLightProjectiveWithShadowVariance ss = b.build();
