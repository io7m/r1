...
@SuppressWarnings("static-method") public final class KImageFilterEmissionTest
{
    ...
    throws Exception
  {
    ...
    final KImageFilterDeferredType<Unit> f = r1.getFilterEmission();
    f.filterEvaluateDeferred(Unit.unit(), fb, fb);
  }
