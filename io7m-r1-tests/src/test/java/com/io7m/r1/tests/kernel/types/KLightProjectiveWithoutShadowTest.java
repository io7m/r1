...
@SuppressWarnings("static-method") public final class KLightProjectiveWithoutShadowTest
{
    ...
    throws Exception
  {
    ...
    final KLightProjectiveWithoutShadowBuilderType b =
      KLightProjectiveWithoutShadow.newBuilder(t, p);
    b.setRange(0.0f);
    b.build();
  }
  ...
  @Test public void testAttributes()
  {
    ...
    final Generator<KProjectionWithShapeType> pg = new KProjectionGenerator();
    final Generator<Texture2DStaticUsableType> tg =
      new RFakeTextures2DStaticGenerator();
    final Generator<KLightProjectiveWithoutShadow> gen =
      new KLightProjectiveWithoutShadowGenerator(
        colour_gen1,
        position_gen1,
        qg,
        pg,
    ...
    QuickCheck.forAllVerbose(
      gen,
      new AbstractCharacteristic<KLightProjectiveWithoutShadow>() {
        @Override protected void doSpecify(
          final KLightProjectiveWithoutShadow s)
          throws Throwable
        {
          {
            final KLightProjectiveWithoutShadowBuilderType b =
              KLightProjectiveWithoutShadow.newBuilderFrom(s);
            final float f = s.lightProjectiveGetFalloff() + 1.0f;
            b.setFalloff(f);
            final KLightProjectiveWithoutShadow r = b.build();
...

          {
            ...
            b.setRange(r);
            final KLightProjectiveWithoutShadow ss = b.build();
