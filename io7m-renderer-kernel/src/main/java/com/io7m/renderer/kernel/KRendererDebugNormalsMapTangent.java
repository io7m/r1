...
@SuppressWarnings("synthetic-access") @EqualityReference public final class KRendererDebugNormalsMapTangent implements
  KRendererDebugType
{
  private static final String NAME = "debug-normals-map-tangent";
