...
@SuppressWarnings("synthetic-access") @EqualityReference public final class KRendererDebugNormalsMapLocal implements
  KRendererDebugType
{
  private static final String NAME = "debug-normals-map-local";
  ...
  {
    return new KRendererDebugNormalsMapLocal(g, shader_cache, log);
  }
    ...
    final LogUsableType in_log)
  {
    this.log =
      NullCheck.notNull(in_log, "Log").with(
        KRendererDebugNormalsMapLocal.NAME);
  ...
  {
    return KRendererDebugNormalsMapLocal.NAME;
  }
