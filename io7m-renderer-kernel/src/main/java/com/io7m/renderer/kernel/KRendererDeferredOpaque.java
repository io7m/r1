  ...
  KRendererDeferredOpaqueType
{
  ...
  public static KRendererDeferredOpaqueType newRenderer(
    ...
    final KShaderCacheDeferredType in_shader_cache)
    throws RException
  {
    return new KRendererDeferredOpaque(in_g, in_shader_cache);
  }
  ...
  private final KShaderCacheDeferredType shader_cache;
    ...
    try {
      ...
      for (final String shader_code : by_material.keySet()) {
        ...
        final KProgram kprogram =
          this.shader_cache.getDeferredGeometry(shader_code);
