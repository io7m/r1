...
@SuppressWarnings("synthetic-access") @EqualityReference public final class KRendererDebugBitangentsLocal implements
  KRendererDebugType
{
  ...
  {
    return new KRendererDebugBitangentsLocal(g, shader_cache, log);
  }
    ...
    final LogUsableType in_log)
  {
    this.log =
      NullCheck.notNull(in_log, "Log").with(
        KRendererDebugBitangentsLocal.NAME);
  ...
  {
    return KRendererDebugBitangentsLocal.NAME;
  }
      ...
      JCacheException
  {
    final KProgram program =
      this.shader_cache.cacheGetLU("debug_bitangents_vertex_local");
              ...
              new MatricesInstanceFunctionType<Unit, JCGLException>() {
                @Override public Unit run(
                  ...
                  throws RException,
                    JCGLException
                {
                  KRendererDebugBitangentsLocal.renderMesh(gc, p, i, mi);
                  return Unit.unit();
                }
              });
          }
