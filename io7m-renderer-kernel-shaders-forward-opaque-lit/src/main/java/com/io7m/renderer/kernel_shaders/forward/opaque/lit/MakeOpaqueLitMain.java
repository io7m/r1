...
package com.io7m.renderer.kernel_shaders.forward.opaque.lit;
...
public final class MakeOpaqueLitMain
{
      ...
      TimeoutException
  {
    ...
    final LogUsableType log = MakeOpaqueLitMain.getLog();
...

    {
      ...
      for (final RKLitCase<KMaterialOpaqueRegular> c : opaque_lit) {
        ...
        writer.append(code);
        writer.append(" : ");
        writer.append(RKForwardShader.PACKAGE_FORWARD_OPAQUE_LIT_REGULAR);
        writer.append(".");
        writer.append(code);
        writer.append(".p");
        writer.append("\n");
    ...
    MakeOpaqueLitMain.makeSourcesList(out_parasol_dir, out_sources);
    MakeOpaqueLitMain.makeCompileSources(
      log,
      out_sources,
      out_batch,
      out_glsl_dir,
      ...
      TimeoutException
  {
    ...
    argslist.add(Integer.toString(MakeOpaqueLitMain.getThreadCount()));
    ...
    EasyCompactor.compact(
      log,
      MakeOpaqueLitMain.getThreadCount(),
      batch,
      out_dir,
      out_compact_dir);
  }
