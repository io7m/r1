...
final class KMaterialCodes
{
  ...
  public static String makeOpaqueRegularUnlitCode(
    final KMaterialAlbedoType in_albedo,
    final KMaterialEmissiveType in_emissive,
    final KMaterialEnvironmentType in_environment,
    final KMaterialNormalType in_normal)
  ...
  public static String makeTranslucentRefractiveUnlitCode(
    final KMaterialNormalType in_normal,
  ...
  public static String makeTranslucentRegularLitCode(
    final KMaterialAlbedoType in_albedo,
  ...
  public static String makeTranslucentRegularUnlitCode(
    final KMaterialAlbedoType in_albedo,
    final KMaterialAlphaType in_alpha,
    final KMaterialEmissiveType in_emissive,
    final KMaterialEnvironmentType in_environment,
  ...
  public static String makeTranslucentSpecularOnlyLitCode(
    final KMaterialAlphaType in_alpha,
    final KMaterialNormalType in_normal,
    final KMaterialSpecularType in_specular)
  {
