...
public interface KInstanceTransformedTranslucentLitVisitorType<A, E extends Throwable>
{
  /**
  ...
  @Nonnull A transformedTranslucentLitRegular(
  ...
  @Nonnull A transformedTranslucentLitSpecularOnly(
