...
/**
 * A mesh with a regular translucent material applied.
 */

@EqualityStructural public final class KMeshWithMaterialTranslucentRegular implements
  KMeshWithMaterialTranslucentType,
  KMeshWithMaterialTranslucentUnlitType,
  KMeshWithMaterialTranslucentLitType,
  KMeshWithMaterialRegularType
{
  /**
  ...
  public static KMeshWithMaterialTranslucentRegular newInstance(
    final KMaterialTranslucentRegular in_material,
    final KMeshReadableType in_mesh,
    final KFaceSelection in_faces)
  {
    return new KMeshWithMaterialTranslucentRegular(
      in_material,
      in_mesh,
      in_faces);
  }
  ...
  private KMeshWithMaterialTranslucentRegular(
    final KMaterialTranslucentRegular in_material,
    final KMeshReadableType in_mesh,
    final KFaceSelection in_faces)
  {
    ...
    final @Nullable Object obj)
  {
    ...
    final KMeshWithMaterialTranslucentRegular other =
      (KMeshWithMaterialTranslucentRegular) obj;
  ...
  @Override public KMaterialTranslucentRegular meshGetMaterial()
  {
  ...
  @Override public
    ...
    meshWithMaterialAccept(
      ...
      throws E,
        ...
        JCGLException
  {
    return v.meshWithMaterialTranslucentRegular(this);
  }
