...
/**
 * A generic transformed instance visitor, returning values of type
...
public interface KInstanceTransformedVisitor<A, E extends Throwable>
{
  /**
  ...
  @Nonnull A transformedVisitOpaque(
