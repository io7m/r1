...
/**
 * <p>
 * A mesh with an opaque material applied.
 * </p>
 * <p>
...
@EqualityStructural public final class KMeshWithMaterialOpaqueRegular implements
  KMeshWithMaterialOpaqueType
{
  ...
  public static KMeshWithMaterialOpaqueRegular newInstance(
    final KMaterialOpaqueRegular in_material,
    final KMeshReadableType in_mesh,
    final KFaceSelection in_faces)
  {
    return new KMeshWithMaterialOpaqueRegular(in_material, in_mesh, in_faces);
  }
  ...
  private KMeshWithMaterialOpaqueRegular(
    final KMaterialOpaqueRegular in_material,
    final KMeshReadableType in_mesh,
    final KFaceSelection in_faces)
  {
    ...
    final @Nullable Object obj)
  {
    ...
    final KMeshWithMaterialOpaqueRegular other =
      (KMeshWithMaterialOpaqueRegular) obj;
  ...
  @Override public KMaterialOpaqueRegular meshGetMaterial()
  {
  ...
  @Override public
    ...
    meshWithMaterialAccept(
      ...
      throws E,
        ...
        JCGLException
  {
    return v.meshWithMaterialOpaqueRegular(this);
  }
}
