...
@EqualityStructural public final class KInstanceTransformedOpaqueAlphaDepth implements
  KInstanceTransformedOpaqueType
{
  ...
  public static KInstanceTransformedOpaqueAlphaDepth newInstance(
    final KInstanceOpaqueAlphaDepth in_instance,
  ...
  private final KInstanceOpaqueAlphaDepth           instance;
  ...
  @Override public KInstanceOpaqueAlphaDepth instanceGet()
  {
  ...
  @Override public
    ...
    instanceAccept(
      ...
      throws E,
        ...
        JCGLException
  {
    return v.instanceOpaqueAlphaDepth(this.instance);
  }
