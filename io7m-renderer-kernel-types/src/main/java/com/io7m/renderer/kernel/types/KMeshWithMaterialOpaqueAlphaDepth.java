...
/**
 * <p>
 * A mesh with an opaque alpha-depth material applied.
 * </p>
 * <p>
 * Meshes with opaque materials may be rendered in any order, and the depth
 * buffer is used to ensure that the transformed instances appear at the
 * correct perceived distance onscreen.
 * </p>
 */

@EqualityStructural public final class KMeshWithMaterialOpaqueAlphaDepth implements
  KMeshWithMaterialOpaqueType
{
  /**
  ...
  public static KMeshWithMaterialOpaqueAlphaDepth newInstance(
    final KMaterialOpaqueAlphaDepth in_material,
    final KMesh in_mesh,
    final KFaceSelection in_faces)
  {
    return new KMeshWithMaterialOpaqueAlphaDepth(
      in_material,
      in_mesh,
      in_faces);
  }
  ...
  private KMeshWithMaterialOpaqueAlphaDepth(
    final KMaterialOpaqueAlphaDepth in_material,
    final KMesh in_mesh,
    final KFaceSelection in_faces)
  {
    ...
    final @Nullable Object obj)
  {
    ...
    final KMeshWithMaterialOpaqueAlphaDepth other =
      (KMeshWithMaterialOpaqueAlphaDepth) obj;
  ...
  @Override public KMaterialOpaqueAlphaDepth meshGetMaterial()
  {
  ...
  @Override public
    ...
    meshWithMaterialAccept(
      ...
      throws E,
        ...
        JCGLException
  {
    return v.meshWithMaterialOpaqueAlphaDepth(this);
  }
}
