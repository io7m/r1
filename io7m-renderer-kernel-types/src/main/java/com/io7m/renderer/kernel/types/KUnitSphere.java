...
/**
 * A unit sphere, with its center at the origin and radius <code>1</code>.
 */

@EqualityReference public final class KUnitSphere implements
  KUnitSphereUsableType
{
   ...
   *
   * @param array
   *          The array buffer, assumed to contain a unit sphere mesh.
   * @param indices
   *          The index buffer.
   * @return A unit sphere.
   */

  public static KUnitSphere newSphere(
    final ArrayBufferType array,
    final IndexBufferType indices)
  {
    return new KUnitSphere(array, indices);
  }
