...
public final class PostprocessingMakeAll
{
      ...
      CompilerError
  {
    ...
    final File out_batch =
      new File(out_parasol_dir, "batch-postprocessing.txt");
    ...
    PostprocessingMakeAll.makeSources(out_parasol_dir);
    PostprocessingMakeAll.makeBatch(out_batch);
      ...
      ConstraintError
  {
    ...
    final InputStream stream =
      PostprocessingMakeAll.class
        .getResourceAsStream("/com/io7m/renderer/kernel_shaders/postprocessing-batch.txt");
