...
--
-- Directional light shaders, normal mapping, no specular terms.
--

module ForwardLitDirectionalNormalMapped is
  ...
  shader vertex fwd_LD_N_vertex is
  ...
  --
  -- Untextured, diffuse-only, normal mapped.
  --

  shader fragment fwd_LD_N_fragment is
  ...
  shader program fwd_LD_N is
    vertex   fwd_LD_N_vertex;
    fragment fwd_LD_N_fragment;
  end;

  --
  -- Textured, diffuse-only, normal mapped.
  --

  shader fragment fwd_LD_T_N_fragment is
    in        f_normal    : vector_3f;
    in        f_tangent   : vector_3f;
    in        f_bitangent : vector_3f;
    in        f_uv        : vector_2f;
