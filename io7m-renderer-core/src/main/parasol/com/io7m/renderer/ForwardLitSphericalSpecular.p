...
--
-- Spherical light shaders, specular terms.
--

module ForwardLitSphericalSpecular is
  ...
  shader vertex fwd_LS_S_vertex is
  ...
  shader fragment fwd_LS_S_fragment is
  ...
  shader program fwd_LS_S is
    vertex   fwd_LS_S_vertex;
    fragment fwd_LS_S_fragment;
  end;
  ...
  shader fragment fwd_LS_T_S_fragment is
    in        f_uv        : vector_2f;
    in        f_normal    : vector_3f;
    in        f_position  : vector_4f;
    parameter material    : M.t;
  ...
  shader program fwd_LS_T_S is
    vertex   fwd_LS_SM_vertex;
    fragment fwd_LS_T_S_fragment;
  end;
  ...
  shader vertex fwd_LS_SM_vertex is
    in        v_uv         : vector_2f;
    in        v_normal     : vector_3f;
    in        v_position   : vector_3f;
    parameter m_normal     : matrix_3x3f;
  ...
  shader fragment fwd_LS_SM_fragment is
    in        f_uv       : vector_2f;
    in        f_normal   : vector_3f;
    in        f_position : vector_4f;
    parameter material   : M.t;
  ...
  shader program fwd_LS_SM is
    vertex   fwd_LS_SM_vertex;
    fragment fwd_LS_SM_fragment;
  end;
  ...
  shader fragment fwd_LS_T_SM_fragment is
    in        f_uv        : vector_2f;
    in        f_normal    : vector_3f;
    in        f_position  : vector_4f;
    parameter material    : M.t;
  ...
  shader program fwd_LS_T_SM is
    vertex   fwd_LS_SM_vertex;
    fragment fwd_LS_T_SM_fragment;
  end;
  ...
  shader fragment fwd_LS_E_S_fragment is
    in        f_normal      : vector_3f;
    in        f_position    : vector_4f;
    parameter material      : M.t;
    parameter light         : SL.t;
  ...
  shader program fwd_LS_E_S is
    vertex   fwd_LS_S_vertex;
    fragment fwd_LS_E_S_fragment;
  end;
  ...
  shader fragment fwd_LS_T_E_S_fragment is
    in        f_normal      : vector_3f;
    in        f_position    : vector_4f;
    in        f_uv          : vector_2f;
    parameter material      : M.t;
  ...
  shader program fwd_LS_T_E_S is
    vertex   fwd_LS_SM_vertex;
    fragment fwd_LS_T_E_S_fragment;
  end;
  ...
  shader fragment fwd_LS_E_SM_fragment is
    in        f_normal      : vector_3f;
    in        f_position    : vector_4f;
    in        f_uv          : vector_2f;
    parameter material      : M.t;
  ...
  with
    ...
    value albedo =
      V3.interpolate (m.diffuse.colour [x y z], env [x y z], F.multiply (m.specular.intensity, m.environment.mix));
  ...
  shader program fwd_LS_E_SM is
    vertex   fwd_LS_SM_vertex;
    fragment fwd_LS_E_SM_fragment;
  end;
  ...
  shader fragment fwd_LS_T_E_SM_fragment is
    in        f_normal      : vector_3f;
    in        f_position    : vector_4f;
    in        f_uv          : vector_2f;
    parameter material      : M.t;
  ...
  with
    ...
    value diff =
      D.diffuse (t_diffuse_0, f_uv, m.diffuse);

    value env =
      CM.reflection (t_environment, f_position [x y z], f_normal, m_view_inv);

    value albedo =
      V3.interpolate (diff [x y z], env [x y z], F.multiply (m.specular.intensity, m.environment.mix));
  ...
  shader program fwd_LS_T_E_SM is
    vertex   fwd_LS_SM_vertex;
    fragment fwd_LS_T_E_SM_fragment;
  end;
