...
--
-- Directional light shaders, normal mapping, specular terms.
--

module ForwardLitDirectionalSpecularNormalMapped is
  ...
  shader vertex fwd_LD_S_N_vertex is
  ...
  --
  -- Untextured, constant specular, normal mapped.
  --

  shader fragment fwd_LD_S_N_fragment is
  ...
  shader program fwd_LD_S_N is
    vertex   fwd_LD_S_N_vertex;
    fragment fwd_LD_S_N_fragment;
  end;

  --
  -- Untextured, specular mapped, normal mapped.
  --

  shader fragment fwd_LD_SM_N_fragment is
    in        f_normal    : vector_3f;
    in        f_tangent   : vector_3f;
    in        f_bitangent : vector_3f;
    in        f_uv        : vector_2f;
  ...
  shader program fwd_LD_SM_N is
    vertex   fwd_LD_S_N_vertex;
    fragment fwd_LD_SM_N_fragment;
  end;

  --
  -- Textured, constant specular, normal mapped.
  --

  shader fragment fwd_LD_T_S_N_fragment is
    in        f_normal    : vector_3f;
    in        f_tangent   : vector_3f;
    in        f_bitangent : vector_3f;
    in        f_uv        : vector_2f;
  ...
  shader program fwd_LD_T_S_N is
    vertex   fwd_LD_S_N_vertex;
    fragment fwd_LD_T_S_N_fragment;
  end;

  --
  -- Textured, specular mapped, normal mapped.
  --

  shader fragment fwd_LD_T_SM_N_fragment is
    in        f_normal    : vector_3f;
    in        f_tangent   : vector_3f;
    in        f_bitangent : vector_3f;
    in        f_uv        : vector_2f;
  ...
  shader program fwd_LD_T_SM_N is
    vertex   fwd_LD_S_N_vertex;
    fragment fwd_LD_T_SM_N_fragment;
  end;

  --
  -- Untextured, environment mapped, constant specular, normal mapped.
  --

  shader fragment fwd_LD_E_S_N_fragment is
    in        f_normal      : vector_3f;
    in        f_tangent     : vector_3f;
    in        f_bitangent   : vector_3f;
    in        f_uv          : vector_2f;
  ...
  shader program fwd_LD_E_S_N is
    vertex   fwd_LD_S_N_vertex;
    fragment fwd_LD_E_S_N_fragment;
  end;

  --
  -- Textured, environment mapped, constant specular, normal mapped.
  --

  shader fragment fwd_LD_T_E_S_N_fragment is
    in        f_normal      : vector_3f;
    in        f_tangent     : vector_3f;
    in        f_bitangent   : vector_3f;
    in        f_uv          : vector_2f;
  ...
  shader program fwd_LD_T_E_S_N is
    vertex   fwd_LD_S_N_vertex;
    fragment fwd_LD_T_E_S_N_fragment;
  end;

  --
  -- Untextured, environment mapped, mapped specular, normal mapped.
  --

  shader fragment fwd_LD_E_SM_N_fragment is
    in        f_normal      : vector_3f;
    in        f_tangent     : vector_3f;
    in        f_bitangent   : vector_3f;
    in        f_uv          : vector_2f;
  ...
  shader program fwd_LD_E_SM_N is
    vertex   fwd_LD_S_N_vertex;
    fragment fwd_LD_E_SM_N_fragment;
  end;

  --
  -- Textured, environment mapped, mapped specular, normal mapped.
  --

  shader fragment fwd_LD_T_E_SM_N_fragment is
    in        f_normal      : vector_3f;
    in        f_tangent     : vector_3f;
    in        f_bitangent   : vector_3f;
    in        f_uv          : vector_2f;
  ...
  with
    ...
    value albedo =
      V3.interpolate (diff [x y z], env [x y z], F.multiply (m.environment.mix, m.specular.intensity));
  ...
  shader program fwd_LD_T_E_SM_N is
    vertex   fwd_LD_S_N_vertex;
    fragment fwd_LD_T_E_SM_N_fragment;
  end;
