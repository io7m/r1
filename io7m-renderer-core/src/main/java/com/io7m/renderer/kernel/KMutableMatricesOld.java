...
@NotThreadSafe final class KMutableMatricesOld
{
    ...
    WithObserver
  {
      ...
      throws ConstraintError
    {
      ...
      KMutableMatricesOld.this.observer_active.set(true);

      /**
       * Calculate projection and view matrices.
       */

      projection.makeMatrixM4x4F(KMutableMatricesOld.this.matrix_projection);
      view.makeMatrixM4x4F(KMutableMatricesOld.this.matrix_view);

      MatrixM4x4F.invertWithContext(
        KMutableMatricesOld.this.matrix_context,
        KMutableMatricesOld.this.matrix_view,
        KMutableMatricesOld.this.matrix_view_inverse);
    }

    @Override public void observerFinish()
    {
      KMutableMatricesOld.this.observer_active.set(false);
    }

    @Override public boolean observerIsActive()
    {
      return KMutableMatricesOld.this.observer_active.get();
    }
      ...
      throws ConstraintError
    {
      ...
      return KMutableMatricesOld.this.matrix_context;
    }
        ...
        throws ConstraintError
    {
      Constraints.constrainArbitrary(
        this.observerIsActive(),
        "Camera is currently active");
      return KMutableMatricesOld.this.matrix_projection;
    }
      ...
      throws ConstraintError
    {
      Constraints.constrainArbitrary(
        this.observerIsActive(),
        "Camera is currently active");
      return KMutableMatricesOld.this.matrix_view;
    }
        ...
        throws ConstraintError
    {
      Constraints.constrainArbitrary(
        this.observerIsActive(),
        "Camera is currently active");
      return KMutableMatricesOld.this.matrix_view_inverse;
    }
    ...
    WithInstance
  {
      ...
      throws ConstraintError
    {
      ...
      KMutableMatricesOld.this.instance_active.set(true);
      ...
      transform.makeMatrix4x4F(
        KMutableMatricesOld.this.transform_context,
        KMutableMatricesOld.this.matrix_model);

      MatrixM4x4F.multiply(
        KMutableMatricesOld.this.matrix_view,
        KMutableMatricesOld.this.matrix_model,
        KMutableMatricesOld.this.matrix_modelview);

      KMatrices.makeNormalMatrix(
        KMutableMatricesOld.this.matrix_modelview,
        KMutableMatricesOld.this.matrix_normal);
      ...
      km.makeMatrixM3x3F(KMutableMatricesOld.this.matrix_uv);
      ki.makeMatrixM3x3F(KMutableMatricesOld.this.matrix_uv_temp);
      MatrixM3x3F.multiplyInPlace(
        KMutableMatricesOld.this.matrix_uv,
        KMutableMatricesOld.this.matrix_uv_temp);
    }
      ...
      throws ConstraintError
    {
      Constraints.constrainArbitrary(
        this.instanceIsActive(),
        "Instance is currently active");
      return KMutableMatricesOld.this.matrix_model;
    }
        ...
        throws ConstraintError
    {
      Constraints.constrainArbitrary(
        this.instanceIsActive(),
        "Instance is currently active");
      return KMutableMatricesOld.this.matrix_modelview;
    }
      ...
      throws ConstraintError
    {
      Constraints.constrainArbitrary(
        this.instanceIsActive(),
        "Instance is currently active");
      return KMutableMatricesOld.this.matrix_normal;
    }
      ...
      throws ConstraintError
    {
      Constraints.constrainArbitrary(
        this.instanceIsActive(),
        "Instance is currently active");
      return KMutableMatricesOld.this.matrix_uv;
    }
    ...
    {
      KMutableMatricesOld.this.instance_active.set(false);
    }

    @Override public boolean instanceIsActive()
    {
      return this.parent.observerIsActive()
        && KMutableMatricesOld.this.instance_active.get();
    }
    ...
    WithProjectiveLight
  {
      ...
      throws ConstraintError
    {
      ...
      KMutableMatricesOld.this.projective_light_active.set(true);
      ...
      KMatrices.makeViewMatrixProjective(
        ...
        KMutableMatricesOld.this.matrix_projective_view);
      ...
      MatrixM4x4F.multiply(
        KMutableMatricesOld.this.matrix_projective_view,
        KMutableMatricesOld.this.matrix_model,
        KMutableMatricesOld.this.matrix_projective_modelview);
      ...
      projective.getProjection().makeMatrixM4x4F(
        KMutableMatricesOld.this.matrix_projective_projection);
    }
    ...
    @Override public void projectiveLightFinish()
      throws ConstraintError
    {
      KMutableMatricesOld.this.projective_light_active.set(false);
    }

    @Override public boolean projectiveLightIsActive()
    {
      return this.parent.instanceIsActive()
        && KMutableMatricesOld.this.projective_light_active.get();
    }
        ...
        throws ConstraintError
    {
      Constraints.constrainArbitrary(
        this.projectiveLightIsActive(),
        "Projective light is currently active");
      return KMutableMatricesOld.this.matrix_projective_modelview;
    }
        ...
        throws ConstraintError
    {
      Constraints.constrainArbitrary(
        this.projectiveLightIsActive(),
        "Projective light is currently active");
      return KMutableMatricesOld.this.matrix_projective_projection;
    }
  }
  ...
  public static @Nonnull KMutableMatricesOld newMatrices()
  {
    return new KMutableMatricesOld();
  }
