...
final class KRendererDebugTangentsVertexLocal implements KRenderer
{
  ...
  KRendererDebugTangentsVertexLocal(
    ...
    throws JCGLCompileException,
      ...
      JCGLException
  {
    this.log = new Log(log, "krenderer-debug-tangents-vertex");
    this.gl = gl;
    ...
    this.program =
      KShaderUtilities.makeProgramSingleOutput(
        ...
        version.getAPI(),
        fs,
        "debug-tangents-vertex-local",
        "debug-tangents-vertex-local.v",
        "debug-tangents-vertex-local.f",
        log);
