...
final class KShadowMapRendererActualOld implements KShadowMapRendererOld
{
  ...
  public static @Nonnull
    ...
    newRenderer(
      ...
      final @Nonnull PCache<KShadow, KShadowMapOld, KShadowCacheException> shadow_cache)
      throws ConstraintError
  {
    return new KShadowMapRendererActualOld(
      gl,
      label_decider,
      shader_cache,
      shadow_cache);
  ...
  private final @Nonnull PCache<KShadow, KShadowMapOld, KShadowCacheException> shadow_cache;
  private @Nonnull State                                                       state;
  private final @Nonnull Context                                               transform_context;
  private final @Nonnull VectorM2I                                             viewport_size;

  private KShadowMapRendererActualOld(
    final @Nonnull JCGLImplementation gl,
    final @Nonnull KMaterialShadowLabelCache label_decider,
    final @Nonnull LUCache<String, KProgram, KShaderCacheException> shader_cache,
    final @Nonnull PCache<KShadow, KShadowMapOld, KShadowCacheException> shadow_cache)
      ...
      JCBExecutionException
  {
    ...
    try {
      KShadowMapRendererActualOld.makeShadowLabel(this.label_cache, label);
      KShadowMapRendererActualOld.renderShadowMapsConfigureDepthColorMasks(
        gc,
        label);
      ...
      e.execRun(new JCBExecutorProcedure() {
            ...
            Throwable
        {
          ...
          for (int index = 0; index < batch.size(); ++index) {
            ...
            try {
              KShadowMapRendererActualOld.this.renderShadowMapMesh(
                gc,
                program,
                mwi,
                instance,
      ...
      JCGLUnsupportedException
  {
    ...
    try {
      ...
      KShadowMapRendererActualOld.handleJCBException(x);
    }
    this.state = State.SHADOW_RENDERER_EVALUATED;
  }
  ...
  @Override public @Nonnull KShadowMapOld shadowRendererGetRenderedMap(
