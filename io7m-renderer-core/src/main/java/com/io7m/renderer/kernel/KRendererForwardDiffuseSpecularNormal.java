...
final class KRendererForwardDiffuseSpecularNormal implements KRenderer
{
  ...
  private final @Nonnull ProgramReference      program_pb_directional_map;
  private final @Nonnull JCCEExecutionCallable exec_pb_directional_map;
  private final @Nonnull ProgramReference      program_pb_spherical_map;
  private final @Nonnull JCCEExecutionCallable exec_pb_spherical_map;
  private final @Nonnull ProgramReference      program_cb_directional_map;
  private final @Nonnull JCCEExecutionCallable exec_cb_directional_map;
  ...
  KRendererForwardDiffuseSpecularNormal(
    ...
    throws JCGLCompileException,
      ...
      IOException
  {
    this.log = new Log(log, "krenderer-forward-diffuse-specular-normal");
    this.gl = gl;
    ...
    this.program_pb_directional_map =
      KShaderUtilities.makeProgram(
        gl.getGLCommon(),
        version.getNumber(),
        version.getAPI(),
        fs,
        "forward_dsmn_pb_directional",
        log);
    this.exec_pb_directional_map =
      new JCCEExecutionCallable(this.program_pb_directional_map);

    this.program_pb_spherical_map =
      KShaderUtilities.makeProgram(
        gl.getGLCommon(),
        version.getNumber(),
        version.getAPI(),
        fs,
        "forward_dsmn_pb_spherical",
        log);
    this.exec_pb_spherical_map =
      new JCCEExecutionCallable(this.program_pb_spherical_map);

    this.program_cb_directional_map =
      KShaderUtilities.makeProgram(
        gl.getGLCommon(),
        version.getNumber(),
        version.getAPI(),
        fs,
        "forward_dsmn_cb_directional",
        log);
    this.exec_cb_directional_map =
      new JCCEExecutionCallable(this.program_cb_directional_map);

    this.program_cb_spherical_map =
      KShaderUtilities.makeProgram(
        gl.getGLCommon(),
        version.getNumber(),
        version.getAPI(),
        fs,
        "forward_dsmn_cb_spherical",
        log);
    this.exec_cb_spherical_map =
      new JCCEExecutionCallable(this.program_cb_spherical_map);
      ...
      JCGLException
  {
    ...
    if (array.hasAttribute(KMeshAttributes.ATTRIBUTE_BITANGENT.getName())) {
      ...
      if (material.getSpecular().getTexture().isSome()) {
        this
          .renderLightPassMeshDirectionalWithProvidedBitangentsWithSpecularMap(
            gc,
            instance);
      } else {
        this
          .renderLightPassMeshDirectionalWithProvidedBitangentsWithoutSpecularMap(
            gc,
            instance);
      }
    } else {
      ...
      if (material.getSpecular().getTexture().isSome()) {
        this
          .renderLightPassMeshDirectionalWithComputedBitangentsWithSpecularMap(
            gc,
            instance);
      } else {
        this
          .renderLightPassMeshDirectionalWithComputedBitangentsWithoutSpecularMap(
            gc,
            instance);
      }
    }
        ...
        JCGLException
  {
    ...
    e.execUniformPutTextureUnit(gc, "t_normal", texture_units.get(2));
        ...
        JCGLException
  {
    ...
    final JCCEExecutionCallable e = this.exec_cb_directional_map;
    e.execPrepare(gc);
    e.execUniformUseExisting("m_projection");
    e.execUniformUseExisting("light.intensity");
    e.execUniformUseExisting("light.color");
  ...
  /**
   * Render the given mesh, lit with the given program, assuming provided
   * bitangents, with a specular map.
   */
      ...
      JCGLException
  {
    ...
    {
      final JCCEExecutionCallable e = this.exec_pb_spherical_map;
      e.execPrepare(gc);
      e.execUniformPutMatrix4x4F(gc, "m_projection", this.matrix_projection);
      e.execUniformPutVector3F(gc, "light.position", light_eye);
      e.execUniformPutVector3F(gc, "light.color", light.getColour());
    ...
    {
      final JCCEExecutionCallable e = this.exec_cb_spherical_map;
      e.execPrepare(gc);
      e.execUniformPutMatrix4x4F(gc, "m_projection", this.matrix_projection);
      e.execUniformPutVector3F(gc, "light.position", light_eye);
      e.execUniformPutVector3F(gc, "light.color", light.getColour());
      ...
      JCGLException
  {
    ...
    if (array.hasAttribute(KMeshAttributes.ATTRIBUTE_BITANGENT.getName())) {
      ...
      if (material.getSpecular().getTexture().isSome()) {
        this
          .renderLightPassMeshSphericalWithProvidedBitangentsWithSpecularMap(
            gc,
            instance);
      } else {
        this
          .renderLightPassMeshSphericalWithProvidedBitangentsWithoutSpecularMap(
            gc,
            instance);
      }
    } else {
      ...
      if (material.getSpecular().getTexture().isSome()) {
        this
          .renderLightPassMeshSphericalWithComputedBitangentsWithSpecularMap(
            gc,
            instance);
      } else {
        this
          .renderLightPassMeshSphericalWithComputedBitangentsWithoutSpecularMap(
            gc,
            instance);
      }
    }
