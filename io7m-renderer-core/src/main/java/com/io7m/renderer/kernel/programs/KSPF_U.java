...
public final class KSPF_U implements KShadingProgram
{
  public static @Nonnull KSPF_U make(
  ...
  {
    this.log =
      new Log(log, KSPForwardUnlitPrograms.KSP_FORWARD_UNLIT.getName());
    ...
    this.program =
      KShaderUtilities.makeProgram(
        ...
        version.getAPI(),
        fs,
        KSPForwardUnlitPrograms.KSP_FORWARD_UNLIT.getName(),
        this.log);
