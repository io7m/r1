...
final class KRendererDebugNormalsMapRaw implements KRenderer
{
  ...
  KRendererDebugNormalsMapRaw(
    ...
    throws JCGLCompileException,
      ...
      JCGLException
  {
    this.log = new Log(log, "krenderer-debug-normals-map-raw");
    this.gl = gl;
    ...
    this.program =
      KShaderUtilities.makeProgramSingleOutput(
        ...
        version.getAPI(),
        fs,
        "debug-normals-map-raw",
        "debug-normals-map-raw.v",
        "debug-normals-map-raw.f",
        log);
