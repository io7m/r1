...
final class KRendererForwardDiffuseSpecularMappedBump implements KRenderer
{
  ...
  KRendererForwardDiffuseSpecularMappedBump(
    ...
    throws JCGLCompileException,
      ...
      IOException
  {
    this.log = new Log(log, "krenderer-forward-diffuse-specular-mapped-bump");
    this.gl = gl;
    ...
    this.program_directional =
      KShaderUtilities.makeProgramSingleOutput(
        ...
        fs,
        "fw_dsmb_directional",
        "fw_dsmb_directional.v",
        "fw_dsmb_directional.f",
        this.log);
      ...
      JCGLException
  {
    ...
    exec.execUniformPutTextureUnit(gc, "t_specular", texture_units[3]);
