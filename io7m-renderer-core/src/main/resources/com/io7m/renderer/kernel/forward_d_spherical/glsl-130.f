#version 130
// Generated: 2013-09-30 14:44:02 +0000
...
vec3
com_io7m_renderer_SphericalLight_diffuse_only (struct_com_io7m_renderer_SphericalLight_t light, vec3 n, vec3 p)
{
  ...
  vec3 c = com_io7m_renderer_SphericalLight_diffuse_color(light, d);
  {
    return (c * a);
  }
}
...
main (void)
{
  ...
  vec3 light_term = com_io7m_renderer_SphericalLight_diffuse_only(light, n, f_position.xyz);
