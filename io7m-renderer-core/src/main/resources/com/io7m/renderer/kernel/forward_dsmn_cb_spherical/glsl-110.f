...
_tmp_8 (void)
{
  ...
  float _tmp_7 = texture2D(t_specular, f_uv).x;
...
main (void)
{
  ...
  pt_com_io7m_renderer_Materials_t mp = _tmp_8();
  vec3 light_term = p_com_io7m_renderer_SphericalLight_diffuse_specular(light, n, f_position.xyz, mp);
