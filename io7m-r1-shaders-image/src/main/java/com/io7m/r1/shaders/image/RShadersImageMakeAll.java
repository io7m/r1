...
package com.io7m.r1.shaders.image;
...
@SuppressWarnings("resource") @EqualityReference public final class RShadersImageMakeAll
{
    ...
    throws Exception
  {
    ...
    try {
      ...
      final List<File> sources =
        RShadersImageMakeAll.makeSourcesList(out_parasol_dir);
