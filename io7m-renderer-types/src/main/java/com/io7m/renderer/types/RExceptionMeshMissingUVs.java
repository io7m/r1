...
@EqualityReference public final class RExceptionMeshMissingUVs extends
  RExceptionUserError
{
  ...
  public RExceptionMeshMissingUVs(
  ...
  public static RExceptionMeshMissingUVs fromArray(
    final ArrayBufferType array)
  {
    final StringBuilder s = new StringBuilder();
    s.append("The given array ");
    s.append(array);
    s.append(" does not have UV coordinates\n");
    ...
    assert r != null;
    return new RExceptionMeshMissingUVs(r);
  }
}
