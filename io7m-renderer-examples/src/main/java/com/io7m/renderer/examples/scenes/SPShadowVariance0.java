...
public final class SPShadowVariance0 implements ExampleSceneType
{
    ...
    throws RException
  {
...

    {
      ...
      final KLightProjectiveBuilderType b =
        KLightProjective.newBuilder(tp, KProjection.fromFrustumWithContext(
          this.projection,
          -1.0f,
          1.0f,
          -1.0f,
